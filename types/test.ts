import { Ulid, UlidMonotonic, Uuid, Uuid1, Uuid4, Uuid6, UuidNil } from 'id128';
...
Ulid.compare(ulid, ulid); // $ExpectType number
Ulid.construct(bytes); // $ExpectType Ulid
Ulid.equal(ulid, ulid); // $ExpectType boolean
...
UlidMonotonic.compare(ulid_monotonic, ulid_monotonic); // $ExpectType number
UlidMonotonic.construct(bytes); // $ExpectType UlidMonotonic
UlidMonotonic.equal(ulid_monotonic, ulid_monotonic); // $ExpectType boolean
...
Uuid.compare(uuid, uuid); // $ExpectType number
Uuid.equal(uuid, uuid); // $ExpectType boolean
...
Uuid1.compare(uuid_1, uuid_1); // $ExpectType number
Uuid1.construct(bytes); // $ExpectType Uuid1
Uuid1.equal(uuid_1, uuid_1); // $ExpectType boolean
...
Uuid4.compare(uuid_4, uuid_4); // $ExpectType number
Uuid4.construct(bytes); // $ExpectType Uuid4
Uuid4.equal(uuid_4, uuid_4); // $ExpectType boolean
...
Uuid6.compare(uuid_6, uuid_6); // $ExpectType number
Uuid6.construct(bytes); // $ExpectType Uuid6
Uuid6.equal(uuid_6, uuid_6); // $ExpectType boolean
...
UuidNil.compare(uuid_nil, uuid_nil); // $ExpectType number
UuidNil.construct(bytes); // $ExpectType UuidNil
UuidNil.equal(uuid_nil, uuid_nil); // $ExpectType boolean
